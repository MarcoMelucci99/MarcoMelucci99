...
![Terminal Quote](https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=C792EA&width=435&lines=It's+not+a+problem%2C+it's+a+feature;Security+is+%28not%29+my+problem;Every+day+is+a+zero-day+when+you+never+update+anything.;Always+be+yourself.+Unless+you+can+be+root.+Then+be+root.+-root;Nothing+rains+in+the+cloud%E2%80%A6+except+alerts+at+3AM.;I'm+not+a+hacker%2C+I'm+a+feature+with+elevated+privileges.)
