...
![Terminal Quote](https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&duration=1500&pause=700&color=16C60C&background=282C34&width=600&prefix=%3E+&lines=It's+not+a+problem%2C+it's+a+feature;Security+is+%28not%29+my+problem;Every+day+is+a+zero-day+when+you+never+update.;Always+be+yourself.+Unless+you+can+be+root.;Nothing+rains+in+the+cloud%E2%80%A6+except+alerts+at+3AM.;I'm+not+a+hacker%2C+I'm+a+feature+with+privileges.)
